...
- 0.4.1 的 bridge 將 core 區提早一個 64-bit word，遇到 `longjmp` 時會還原錯誤的 LR/SP；0.4.3 已修正。
...
workflow：`GoreBoxRunner Launch 0.4.3 - Unsigned IPA`

產物：`GoreBoxRunner-Launch-0.4.3-unsigned.ipa`
