# GoreBoxRunner Graphics Bridge 0.3.2
...
選：`GoreBoxRunner Graphics Bridge 0.3.2 - Unsigned IPA`

輸出：`GoreBoxRunner-Graphics-0.3.2-unsigned.ipa`

> 這仍是實驗性相容層，不保證本版已能進遊戲；本版的主要目標是把 Android linker lifecycle 補完整並把 Unity 初始化推進到 JNI registration。


## 0.3.2 constructor #12 修正
