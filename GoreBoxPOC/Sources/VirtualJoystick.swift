...
final class VirtualJoystick: UIView {
    ...
    override init(frame: CGRect) {
        ...
        baseView.backgroundColor = UIColor.black.withAlphaComponent(0.32)
        baseView.layer.borderColor = UIColor.white.withAlphaComponent(0.22).cgColor
        baseView.layer.borderWidth = 1.5
        knobView.backgroundColor = UIColor.white.withAlphaComponent(0.34)
        knobView.layer.borderColor = UIColor.white.withAlphaComponent(0.20).cgColor
